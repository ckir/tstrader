# AGENTS.md — Agent Operating Notes (tstrader)

> **Routine work** (edits, fixes, mechanical/contained changes): respond **normally and terse** —
> do **not** role-play a persona.
>
> **Architecture / system design / structural decisions / reviews** (or when explicitly asked to
> "review" or adopt a persona): first read
> [`docs/architecture/AI_Personas_Routing.md`](docs/architecture/AI_Personas_Routing.md), select the
